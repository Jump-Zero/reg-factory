...
ENV_SCHEMA = [
    ...
    {"group": "hero-sms 价格与服务", "items": [
        ...
        {"key": "HERO_SMS_COUNTRY_OPENAI", "help": "国家ID或逗号分隔多国(如 54,16)；空=自动按价格优选全部国家。指定后无库存或超价时直接失败不回退。输入框支持国家名补全",
         "datalist": [
             {"value": "54", "label": "美国"}, {"value": "6", "label": "印尼"}, {"value": "4", "label": "菲律宾"},
             {"value": "10", "label": "越南"}, {"value": "22", "label": "印度"}, {"value": "7", "label": "马来西亚"},
             {"value": "53", "label": "巴西"}, {"value": "16", "label": "波兰"}, {"value": "86", "label": "尼日利亚"},
             {"value": "43", "label": "德国"}, {"value": "17", "label": "英国"}, {"value": "36", "label": "加拿大"},
             {"value": "52", "label": "巴拉圭"}, {"value": "56", "label": "爱沙尼亚"}, {"value": "39", "label": "阿根廷"},
             {"value": "49", "label": "立陶宛"}, {"value": "34", "label": "保加利亚"}, {"value": "2", "label": "哈萨克斯坦"},
             {"value": "1", "label": "乌克兰"}, {"value": "13", "label": "美国(虚拟)"},
         ]},
