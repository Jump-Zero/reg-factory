...
SCRIPTS = [
    # ---------------------------------------------------------------- 主流程
    {
        ...
        "category": "主流程",
        "title": "端到端全流程",
        "desc": "并发注册 Outlook 邮箱，并为每个邮箱同时运行所选平台。",
        "warning": "浏览器流程统一使用所选 Chromium provider；推荐 BitBrowser 以获得独立 Profile、Cookie 和指纹。",
        "args": [
            {"flag": "--platforms", "type": "multi", "choices": ["claude", "chatgpt", "grok", "kiro", "github"],
    ...
    },
    {
        ...
        "category": "主流程",
        "title": "多平台注册(已有邮箱)",
        "desc": "用现成邮箱(或从 emails.txt 池)在所选平台注册。",
        "args": [
