...
ENV_SCHEMA = [
    ...
    {"group": "指纹浏览器", "tests": [{"target": "bitbrowser", "label": "测试 指纹浏览器连通"}], "items": [
        {"key": "FINGERPRINT_BROWSER", "type": "choice", "choices": ["bundled", "custom", "bitbrowser", "adspower", "custom_api"],
         "default": "bundled", "help": "custom=普通 Chrome/Chromium；custom_api=BitBrowser 兼容的其他指纹浏览器 API。"},
