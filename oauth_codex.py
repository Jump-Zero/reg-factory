...
async def main():
    ...
    parser.add_argument("--sms-provider", choices=["auto", "custom", "smsman", "firefox", "hero", "liye"], default="auto",
                        help="自动接码平台；auto 按 sms-man、firefox.fun、hero-sms、liye(卡密式,配了才启用) 轮换")
